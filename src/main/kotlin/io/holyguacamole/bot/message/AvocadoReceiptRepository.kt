...
class AvocadoReceiptRepository(
    ...
    fun findBySenderToday(sender: String): List<AvocadoReceipt> = mongoRepository.findBySenderAndTimestampGreaterThan(sender, ZonedDateTime.of(LocalDate.now(), LocalTime.MIDNIGHT, ZoneId.systemDefault()).withZoneSameInstant(ZoneId.of("UTC")).toEpochSecond())
